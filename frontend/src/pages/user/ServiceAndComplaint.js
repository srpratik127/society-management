                ...
                <div className="bg-white p-4 rounded-lg">
                    <div className="flex justify-between items-center mb-3">
                        ...
                        <div className="bg-gradient-to-r from-[#FE512E] to-[#F09619] rounded-lg px-3 py-2 text-white font-semibold">
                            <button onClick={handleOpenCreateComplaintModal}>Create Complaint</button>
                        </div>
                    </div>
            ...
            {activeTab === "requests" && (
                <div className="bg-white p-4 rounded-lg">
                    <div className="flex justify-between items-center mb-3">
                        ...
                        <div className="bg-gradient-to-r from-[#FE512E] to-[#F09619] rounded-lg px-3 py-2 text-white font-semibold">
                            <button onClick={handleOpenCreateRequestModal}>Create Request</button>
                        </div>
                    </div>
                    {serviceandComplaint?.length > 0 ? (
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <p className="text-gray-500">No requests to display at the moment.</p>
                    )}
                </div>
            )}

            {isCreateComplaintModalOpen && (
                <CreateComplaintTracking onClose={handleCloseCreateComplaintModal} />
            )}

            {isCreateRequestModalOpen && (
                <CreateComplaintTracking onClose={handleCloseCreateRequestModal} /> 
            )}
        </div>
    );
};
