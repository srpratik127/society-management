      ...
      <div className="bg-white rounded-xl p-6 w-96">
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div key={field} className="mb-4">
              ...
              {field === "description" ? (
                <textarea
                  ...
                  className={`w-full border rounded-md outline-none p-2 mt-1 ${
          ...
          <div className="flex gap-3">
            <button
              onClick={onClose}
              className="border font-semibold text-gray-700 w-1/2 py-2 rounded-lg"
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={loader}
              className="w-1/2 py-2 bg-gradient-to-r from-[#FE512E] to-[#F09619] text-white font-semibold rounded-lg"
            >
              {!loader ? "Save" : <Loader />}
            </button>
          </div>
