...
const AddTenant = () => {
    ...
    return (
        <div>
            <div className="flex flex-wrap justify-between items-center bg-white p-4 rounded-xl mb-2 mx-8 shadow space-y-4 md:space-y-0">
                                    ...
                                    {['Type', 'Name', 'Number'].map((field, idx) => {
                                        ...
                                        return (
                                            <div className="flex flex-col w-full" key={idx}>
                                                ...
                                                <input
                                                    type="text"
                                                    className={`border ${errors[fieldKey] ? 'border-red-500' : 'border-gray-300'} rounded-lg p-2 w-full focus:outline-none`}
