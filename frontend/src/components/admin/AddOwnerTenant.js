...
const AddOwnerTenant = ({ role, editResident }) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      formData.append(
        "aadharCardFront",
        files["Upload Aadhar Card (Front Side)"]
      );
      formData.append(
        "aadharCardBack",
        files["Upload Aadhar Card (Back Side)"]
      );
      formData.append(
        "addressProof",
        files["Address Proof (Vera Bill OR Light Bill)"]
      );
  ...
  return (
    <div className="justify-center bg-gray-100 px-4 text-sm">
      {role === "tenant" && (
            ...
            {[
              ...
              return (
                <div className="flex flex-col" key={index}>
                  <label className="text-gray-700 font-semibold py-2">
                    {label}
                  </label>
                  {isSelect ? (
                    <select
                      ...
                      onChange={(e) =>
                        setMainUser({ ...mainUser, gender: e.target.value })
                      }
                    >
                    ...
                    <input
                      ...
                      maxLength={keys[index] === "phoneNumber" && "10"}
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            <div key={index} className="flex flex-col">
              <label className="text-gray-700 font-semibold py-3">
                {label}
              </label>
              <div
      ...
      <div className="">
        <div className="flex flex-col md:items-center gap-4 bg-[#ffff] my-2 px-8 pb-4 rounded-lg shadow">
          <div className="flex flex-col md:flex-row justify-between w-full items-center border-b-2 py-2 gap-4">
            ...
            <div className="flex justify-center align-center">
              ...
              <select
                ...
                value={members}
                onChange={(e) =>
                  handleCountChange(setMembers, parseInt(e.target.value, 10))
                }
              >
                {[1, 2, 3, 4, 5].map((num) => (
          ...
          {Array.from({ length: members }).map((_, index) => (
            <div
              key={index}
              className="grid grid-cols-1 md:grid-cols-6 gap-6 w-full mt-2"
            >
              {["Name", "Phone", "Email", "Age", "Gender", "Relation"].map(
                (label, idx) => {
                    ...
                    <div className="flex flex-col" key={idx}>
                      ...
                      {label === "Gender" ? (
                        <select
                          ...
                          value={
                            memberDetails[index]?.gender || "Select Gender"
                          }
                          onChange={(e) =>
                            handleDetailChange(
                              setMemberDetails,
                        ...
                        <input
                          ...
                          value={
                            memberDetails[index] && memberDetails[index][field]
                              ? memberDetails[index][field]
                              : ""
                          }
                          onChange={(e) =>
                            handleDetailChange(
                      ...
                      <div className="flex flex-col w-full" key={idx}>
                        ...
                        {label === "Type" ? (
                          ...
                          <input
                            ...
                            value={
                              vehicles[index] && vehicles[index][field]
      ...
      <div className="flex justify-end gap-3 mt-4 mb-4">
        <Link
          to="/admin/resident"
          className="border text-[#202224] bg-white px-4 py-2 rounded-md"
        >
          Cancel
        </Link>
        <button
          ...
          disabled={loader}
          className="bg-gradient-to-r from-[#FE512E] to-[#F09619] text-white px-4 py-2 rounded-md"
        >
